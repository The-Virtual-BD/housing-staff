...
export default function UserJoiningChart() {
  ...
  return (
    <div className="card card-shadow">
      <div className="card-header d-flex justify-content-between align-items-center">
        <h6 className="fw-bold mb-0">User Joining Status</h6>
        <div>
          <button {...registerParam("daily", param, setParam)}>Daily</button>
          <button {...registerParam("weekly", param, setParam)}>Weekly</button>
          <button {...registerParam("monthly", param, setParam)}>
            Monthly
          </button>
          <button {...registerParam("yearly", param, setParam)}>Yearly</button>
        </div>
      </div>
